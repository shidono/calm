...
void main(){
    ...
    SDL_Surface *pos3[4],*pos2[2];
    simple screen,image,circuit,locked,unlocked;
    SDL_Event event;
    ...
    unlocked.image = IMG_Load("/home/shidono/Desktop/circuit/unlocked.png");
    locked.image = IMG_Load("/home/shidono/Desktop/circuit/locked.png");
    ...
    pos2[1] = IMG_Load("/home/shidono/Desktop/circuit/2pos2.png");
     //correct places
    /*
    firstleft.image = pos32;
    middle.image = pos31;
    bottom.image = pos21;
    finalpos3.image = pos32;
    finalpos2.image = pos21;
    */
                    ...
                    if(( a || b || c) && SDL_BUTTON(SDL_BUTTON_LEFT)){
                        if(a){
                            ...
                            if(base3[1].direction == 3){
                                ...
                                base3[1].direction++;
                                base3[1].image = pos3[base3[0].direction];
                            }
                        }else if(c){
                            if(base3[2].direction == 3){
                                ...
                                base3[2].direction++;
                                base3[2].image = pos3[base3[0].direction];
                            }
                        }
